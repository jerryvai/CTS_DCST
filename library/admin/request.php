...
<div class="container">
 ...
 if (isset($_SESSION['login_user'])) 
 {
   $sql=" SELECT fstudent.username,roll,books.bid,name,authors,edition,status FROM fstudent inner join issue_book ON fstudent.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve='';";
